...
// --- WAKE UP THE ZOOM ENGINE ---
   ...
   if (err == ZOOM_SDK_NAMESPACE::SDKERR_SUCCESS) {
        ...
        if (err == ZOOM_SDK_NAMESPACE::SDKERR_SUCCESS && auth_service) {
            ...
            authContext.jwt_token = L"eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHBLZXkiOiJZNzNqelFSbVF4aWhoNFo3MnFSMnRnIiwiaWF0IjoxNzc0MDUwMDAwLCJleHAiOjE3NzY2NDIwMDAsInRva2VuRXhwIjoxNzc2NjQyMDAwfQ.xCGQuoIhgbAjAkj9Mvm4NCVLUtwuEKuyxo9riRLX2A4"; 
